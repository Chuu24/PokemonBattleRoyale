                    ...
                    <div class="row contenido">
                            ...
                            <div class="scrollbar-inner dex">
                                <table class="table-responsive table-striped pokedexTable">
                                    ...
                                    <c:forEach items="${requestScope.myPokes}" var="p">
                                        <tr>
                                            <td>#<fmt:formatNumber value="${p.idPokemon}" minIntegerDigits="3" /> - <c:out value="${p.nickname}" /></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
                        ...
                        <div class="col-md-8">
                            ...
                            <div clas="row">
                                ...
                                <div class="col-md-4">
                                    <img src="img/pokecenter.png" class="img-responsive" />
                                </div>
                                <div class="col-md-4"></div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4 no-overgrow">
                                    <table class="table-responsive team-member">
                                        ...
                                        <tr>
                                            ...
                                            <td width="30%">
                                                ${p.nickname} <br> <br> Health: ${p.health}
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="row">
                                <form action="./heal" method="POST">
                                    <input value="Heal" type="submit" class="btn2" style="margin-right:20px; width: 100%;" />
                                </form>
                            </div>
                        </div>
                        <div class="col-md-1"></div>
