    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response){
        try{
            ...
            if(nick == null || nick.equals("")){
                stat.executeUpdate("INSERT INTO capturados VALUES (" + idPok + "," + idUsuario + ",\"" + nombre + "\",\"" + nivel + "\",\"" + hab + "\",\"" + at1 + "\",\"" + at2 + "\",\"" + at3 + "\",\"" + at4 + "\");");
            }else{
                stat.executeUpdate("INSERT INTO capturados VALUES (" + idPok + "," + idUsuario + ",\"" + nick + "\",\"" + nivel + "\",\"" + hab + "\",\"" + at1 + "\",\"" + at2 + "\",\"" + at3 + "\",\"" + at4 + "\");");
            }
